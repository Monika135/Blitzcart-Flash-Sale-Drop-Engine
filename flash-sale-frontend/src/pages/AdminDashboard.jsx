...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen px-4 pb-10 pt-28 sm:px-6 md:px-8 max-w-6xl mx-auto page-in">
      <div className="mb-8"><p className="mb-2 text-xs font-semibold uppercase tracking-[.2em] text-sour">Operations centre</p><h1 className="font-display text-3xl font-bold tracking-tight">VibeEnergy live drop</h1><p className="mt-2 text-sm text-ink-muted">Real-time inventory, reservations and payment reconciliation.</p></div>
